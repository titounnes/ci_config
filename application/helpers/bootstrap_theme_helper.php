                ...
                <ul class="dropdown-menu"> 
                  ...
                  <li class="user-body">
                    <div class="col-xs-4 text-center">
                      <a href="#" data-href="auth/email/load" class="btn-ajax" title="Change Email" data-toggle="modal" data-target="#myModal">
                        Ganti e-Mail
                      </a> 
                    </div>
                    <div class="col-xs-4 text-center"> 
                      <a href="#" data-href="auth/password/load" class="btn-ajax" title="Change Password" data-toggle="modal" data-target="#myModal">
                        Ubah Password
                      </a>
                    </div>
                    <div class="col-xs-4 text-center"> 
                  ...
                  <li class="user-body"> 
                    ...
                    <div class="pull-right"> 
                      <a href="#" data-href="auth/logout/index" class="btn-logout-confirm" title="Log Out" data-toggle="modal" data-target="#myModal">
                        Keluar
                      </a> 
                    </div>
                  </li>
